	...
	while True:
		...
		if chc == "1":
			try:
				...
				seed = random.randint(1, 100000000000000000)
...
I'm glad you came this far, I appreciate you playing this game, I'll tell you something; If you come to this place again and write "got god powers" as an answer, you will have god powers."""
			...
			talkscreen(["A?: Would it be right for us to show him each of the universes?", "V?: He can't tell us what his intentions are and besides I think he hears us", "A?: In fact, was he aware that the game did not end when he killed the puppet god?", "V?: So let's show him the facts"])
			for h in range(1000):
				root2 = Universe(h)
				print(root2.data)
			talkscreen(["V?: We showed him around 1000 universes", "V?: Okay, I think he understands how many and unique universes are.", "A?: no, he didn't even think about it, he just wanted to learn the meaning of the texts passing in front of him (Universe Json Data)"])
			talk = input("Talk: ")
			talkscreen([f"{root.data['user'][0]}: {talk}", "V?: No way, he managed to come here.", "A?: I gave him this, so that he could see the truth for himself.", "V?: Okay, call me and let's have a chat."])
			for _ in range(15):
				clear()
			import webbrowser
			webbrowser.open("https://discord.gg/HRsSeQV4vA")
			break
		else:
			clear()
			print("\033[0m")
						...
						if chc == "y":
							...
							if target == "God":
								...
								for _ in range(100):
									root.userPowerUp()
							if target == "Vorathar":
								talkscreen(["A?: Hey, what happened to you?", "V?: ...", "A?: Answer me, you are very strong, you cannot be defeated so easily!", "V?: t-that k-k-k-killed me", "A?: How can you defeat the most helpless servant..."])
